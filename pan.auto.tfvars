...
pan_mgmt_profile = {
  INSIDE    = { ping = true, ssh = true, http = false, https = true, permitted_ips = ["10.10.10.0/24"] }
...
pan_addresses = {
  ...
  NET4_TERRAFORM      = { type = "ip-netmask", value = "10.10.10.0/24", description = "Terraform network", tags = ["CLIENTS", "TERRAFORM"] }
